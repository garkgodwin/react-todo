...
function Form({todo, setTodo, todos, setTodos}) {
    ...
    return (
        <form className="Form" onSubmit={handleSubmit}>
            <InputBox cName="input-primary" placeholder="...enter your todo here" value={todo} setValue={setTodo} /> 
            <Button cName="btn-primary" icon={formState.submitIcon} handleClick={handleSubmit}/>
        </form>
    )
}
